...
- **action** _`"create" | "edit"`_ - The latest action related to the post. _(optional)_
- **author** _`string`_ - The last author on the post.
- **content** _`string`_ - The content of the post.
- **date** _`Date`_ - The date of the last action on the post.
- **title** _`string`_ - The title of the post. _(optional)_
- **views** _`number`_ - The number of views on the post. _(optional)_
