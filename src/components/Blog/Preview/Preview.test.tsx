import Preview from '@lib/components/Blog/Preview';
...
vi.mock('next/link', () => {
  return {
    __esModule: true,
    default: ({ href, children }: any) => React.createElement('a', { href }, children as ReactNode),
  };
});
...
vi.mock('components/Markdown', () => {
  return {
    ...
    default: ({ children }: any) =>
      React.createElement('div', { 'data-testid': 'markdown' }, children as ReactNode),
  };
});
...
describe('Preview component', () => {
  ...
  it('throws if url prop is not provided', () => {
    ...
    expect(() =>
      render(<Preview title={title} excerpt={excerpt} date={date} url={'' as any} />),
