...
type SocialMediaListStoryProps = ComponentProps<typeof SocialMediaList> & SocialMediaListDisplayProps;
...
const meta: Meta<SocialMediaListStoryProps> = {
  ...
  argTypes: {
    ...
    showHandles: {
      control: "boolean",
      description: "Part of the display properties. Determines whether to show the user's handle with the media icon.",
    },
    socials: {
      control: "object",
    },
