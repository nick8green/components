 ...
 */
vi.mock('@lib/components/Accordion/Item', () => {
  return {
    default: (props: any) =>
      React.createElement(
        'li',
...
describe('Accordion component', () => {
  ...
  it('toggles an item open and closed when clicked', () => {
    const items = [{ title: 'First Item', children: <span>First content</span> }];
    ...
    expect(screen.getByTestId('content-First Item')).toHaveTextContent('First content');
