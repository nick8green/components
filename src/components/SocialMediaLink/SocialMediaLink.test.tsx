...
describe("Social Media Link Component", () => {
  describe("for each platform", () => {
    ...
    testCases.forEach(({ handle, platform, url, handleText, iconName }) => {
      test(`renders social media link for ${handle}`, () => {
  ...
  test("does not add display handler class when the should be hidden", () => {
    render(
      <Socials
        handle="Twitter"
        platform={Platform.X}
