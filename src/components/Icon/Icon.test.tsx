...
describe('Icon', () => {
  ...
  it('renders FontAwesomeIcon with correct props when icon exists', () => {
    render(<Icon pack="solid" name="coffee" size="2x" className="test-class" title="Test Icon" />);
  ...
  it('renders null and warns when icon does not exist', () => {
    ...
    expect(warnSpy).toHaveBeenCalledWith('Icon "nonexistent" not found in pack "solid"');
    warnSpy.mockRestore();
  });
